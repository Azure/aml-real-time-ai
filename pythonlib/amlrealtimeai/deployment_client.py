...
class AsyncOperationFailedException(Exception):
    ...
    def __str__(self):
        return self.__friendly_operation_name + ' failed with error ' + self.__error_message + ' (' + error_details + '); Original request id: ' + self.__request_id + '; ' + self.__operation_type + '; operation_id: ' + self.__operation_id + '; resource_location: ' + self.__resource_location
